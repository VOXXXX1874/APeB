...
def log_io(func: Callable) -> Callable:
    """
    A decorator that logs tool status without recording inputs or outputs.
    ...
    def wrapper(*args: Any, **kwargs: Any) -> Any:
        ...
        logger.debug("Tool %s started", func_name)

        # Execute the function
        result = func(*args, **kwargs)

        logger.debug("Tool %s completed", func_name)
...
class LoggedToolMixin:
    ...
    def _log_operation(self, method_name: str, *args: Any, **kwargs: Any) -> None:
        ...
        logger.debug("Tool %s.%s started", tool_name, method_name)

    def _run(self, *args: Any, **kwargs: Any) -> Any:
        """Override _run method to add logging."""
        self._log_operation("_run", *args, **kwargs)
        result = super()._run(*args, **kwargs)
        logger.debug("Tool %s completed", self.__class__.__name__.replace("Logged", ""))
        return result
